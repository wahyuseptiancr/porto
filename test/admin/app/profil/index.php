                ...
                <div class="x_content">
                  ...
                  <form id="demo-form2" method="post" data-parsley-validate class="form-horizontal form-label-left">
					...
					<div class="form-group" id="nama_course">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12" for="nama_course">Sistem Aplikasi Terintegrasi
                      </label>
                    ...
                    <div id="founder" class="form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12" for="founder">Admin, Operator & Moderator
                      </label>
                      <div class="col-md-6 col-sm-6 col-xs-12">
