...
<body data-spy="scroll" data-target="#navbar-example">
			...
			<div class="row about-us-text">
				<div class="col-md-12">
					<p class="text-center">Selamat datang di E-Learning <?php echo "$course"; ?><br>
						<?php echo "$course"; ?> merupakan sebuah aplikasi berbasis web yang di gunakan untuk ujian online SIPEPI
						Silahkan anda mendaftar terlebih dahulu agar dapat melakukan ujian online SIPEPI
						setelah anda selesai mendaftar silahkan login. di halaman user anda dapat mengedit biodata. Hasil ujian dapat dilihat secara langsung</p>
				</div>
			</div> <!-- row -->
	...
	<section id="footer" class="main-footer">
		<div class="container">
			<p>&copy; 2022 Programmer Wahyu Septian, Bidang Pendidikan Pelatihan dan Akreditasi </a></p>
			</p>
